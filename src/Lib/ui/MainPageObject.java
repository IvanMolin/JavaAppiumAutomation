...
public class MainPageObject {
    ...
    public boolean assertElementHasText1(By by, String expected_conditions, String error_message, long timeoutInSeconds)
    {
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        wait.withMessage(error_message + "\n");
        return wait.until(
    ...
    public void assertElementHasText(WebElement locator, String expected_text,String error_message)
    {
    ...
    public void swipeUpToFindElement(String locator,String error_message, int max_swipes)
    {
        ...
        while (driver.findElements(by).size() == 0){
            if (already_swiped > max_swipes){
                waitForElementPresent(locator, "Cannot element by swiping up. \n" + error_message, 0);
                return;
            }
